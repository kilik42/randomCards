...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CardsRandom",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11CardsRandom11AppDelegate")
...
SWIFT_CLASS("_TtC11CardsRandom15CardSelectionVC")
...
- (IBAction)restartButtonTapped:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC11CardsRandom13SceneDelegate")
...
SWIFT_CLASS("_TtC11CardsRandom14ViewController")
